"""
Cyber Agent Communication Component
...
logger = logging.getLogger("CyberAgent.Communication")


class CyberCommunication:
    """Cyber Threat Detection Communication Component."""
    ...
    def __init__(self, agent_id: str, config: Dict[str, Any], 
        ...
        self.publish_topic = mqtt_config.get('publish_topics', ['predictions/cyber_agent'])[0]
        
        self.app = FastAPI(title=f"{agent_id} API")
        self.api_port = config.get('api', {}).get('port', 8003)
        ...
        self._setup_routes()
        logger.info(f"Initialized Cyber Communication (MQTT: {broker}:{port}, API: {self.api_port})")
        ...
        try:
            message = {
                ...
                "prediction": {
                    ...
                    "consecutive_anomalies": prediction.get('consecutive_anomalies'),
